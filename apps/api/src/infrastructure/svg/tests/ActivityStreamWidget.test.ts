...
import { renderActivityStreamSVG } from '../ActivityStreamWidget';
import { getTheme } from '../themes';
import { dictionaries } from '../locales';

describe('ActivityStreamWidget SVG', () => {
  ...
  it('renders successfully without throwing', () => {
    const svg = renderActivityStreamSVG({ activityStream: mockProfile.activityStream, theme: defaultTheme, lang: "en" });
  ...
  it('applies the correct theme colors (Light)', () => {
    ...
    const svg = renderActivityStreamSVG({ activityStream: mockProfile.activityStream, theme: lightTheme, lang: "en" });
  ...
  it('handles empty data safely', () => {
    ...
    expect(() => renderActivityStreamSVG({ activityStream: mockProfile.activityStream, theme: defaultTheme, lang: "en" })).not.toThrow();
  });
