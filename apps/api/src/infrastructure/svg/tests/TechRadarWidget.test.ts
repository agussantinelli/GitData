...
import { renderTechRadarSVG } from '../TechRadarWidget';
import { getTheme } from '../themes';
import { dictionaries } from '../locales';

describe('TechRadarWidget SVG', () => {
  ...
  it('renders successfully without throwing', () => {
    const svg = renderTechRadarSVG({ techRadar: mockProfile.techRadar, theme: defaultTheme, lang: "en" });
  ...
  it('applies the correct theme colors (Light)', () => {
    ...
    const svg = renderTechRadarSVG({ techRadar: mockProfile.techRadar, theme: lightTheme, lang: "en" });
  ...
  it('handles empty data safely', () => {
    ...
    expect(() => renderTechRadarSVG({ techRadar: mockProfile.techRadar, theme: defaultTheme, lang: "en" })).not.toThrow();
  });
