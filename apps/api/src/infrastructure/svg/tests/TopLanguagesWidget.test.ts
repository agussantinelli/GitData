...
import { renderTopLanguagesSVG } from '../TopLanguagesWidget';
import { getTheme } from '../themes';
import { dictionaries } from '../locales';

describe('TopLanguagesWidget SVG', () => {
  ...
  it('renders successfully without throwing', () => {
    const svg = renderTopLanguagesSVG({ languages: mockProfile.topLanguages, theme: defaultTheme, lang: "en" });
  ...
  it('applies the correct theme colors (Light)', () => {
    ...
    const svg = renderTopLanguagesSVG({ languages: mockProfile.topLanguages, theme: lightTheme, lang: "en" });
  ...
  it('handles empty data safely', () => {
    ...
    expect(() => renderTopLanguagesSVG({ languages: mockProfile.topLanguages, theme: defaultTheme, lang: "en" })).not.toThrow();
  });
